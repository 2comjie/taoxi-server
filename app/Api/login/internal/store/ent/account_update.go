...
func (_u *AccountUpdate) SetIsDeleted(v bool) *AccountUpdate {
	_u.mutation.SetIsDeleted(v)
	return _u
}

// SetNillableIsDeleted sets the "is_deleted" field if the given value is not nil.
func (_u *AccountUpdate) SetNillableIsDeleted(v *bool) *AccountUpdate {
	if v != nil {
		_u.SetIsDeleted(*v)
	}
	return _u
...
func (_u *AccountUpdate) SetUpdateAtUnix(v int64) *AccountUpdate {
...
func (_u *AccountUpdate) AddUpdateAtUnix(v int64) *AccountUpdate {
...
func (_u *AccountUpdate) defaults() {
	if _, ok := _u.mutation.UpdateAtUnix(); !ok {
		v := account.UpdateDefaultUpdateAtUnix()
		_u.mutation.SetUpdateAtUnix(v)
	}
}
...
func (_u *AccountUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedUpdateAtUnix(); ok {
		_spec.AddField(account.FieldUpdateAtUnix, field.TypeInt64, value)
	}
...
// SetIsDeleted sets the "is_deleted" field.
func (_u *AccountUpdateOne) SetIsDeleted(v bool) *AccountUpdateOne {
	_u.mutation.SetIsDeleted(v)
	return _u
}

// SetNillableIsDeleted sets the "is_deleted" field if the given value is not nil.
func (_u *AccountUpdateOne) SetNillableIsDeleted(v *bool) *AccountUpdateOne {
	if v != nil {
		_u.SetIsDeleted(*v)
	}
	return _u
...
// SetUpdateAtUnix sets the "update_at_unix" field.
func (_u *AccountUpdateOne) SetUpdateAtUnix(v int64) *AccountUpdateOne {
	_u.mutation.ResetUpdateAtUnix()
	_u.mutation.SetUpdateAtUnix(v)
	return _u
}
...
// AddUpdateAtUnix adds value to the "update_at_unix" field.
func (_u *AccountUpdateOne) AddUpdateAtUnix(v int64) *AccountUpdateOne {
	_u.mutation.AddUpdateAtUnix(v)
	return _u
}
