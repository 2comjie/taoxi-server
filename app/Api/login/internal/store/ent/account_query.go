...
func (_q *AccountQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *AccountQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *AccountQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *AccountQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *AccountQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *AccountQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(account.FieldIsDeleted).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
