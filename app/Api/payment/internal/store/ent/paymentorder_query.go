...
func (_q *PaymentOrderQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PaymentOrderQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *PaymentOrderQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PaymentOrderQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *PaymentOrderQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *PaymentOrderQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PaymentOrderQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(paymentorder.Table, paymentorder.Columns, sqlgraph.NewFieldSpec(paymentorder.FieldID, field.TypeUint64))
	_spec.From = _q.sql
